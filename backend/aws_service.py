...
_client_cache: dict = {}          # region -> boto3 client
_region_cache: dict = {}          # bucket_name -> region string
_probe_client = None              # global probe client for region detection
...
def _detect_bucket_region(bucket_name: str) -> str:
    """
...
def delete_s3_bucket(bucket_name: str, region: str = "") -> dict:
    """
    ...
    try:
        ...
        region = _detect_bucket_region(bucket_name)
